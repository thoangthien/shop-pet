...
public class OrderController extends CommonController{
	...
	//tiêm bean vào orderDetailService
	@Autowired
	...
	// xử lý show list đơn hàng
	@GetMapping(value = "/admin/orders")
	public String orders(Model model, Principal principal) {
		//gán list sản phẩm tìm được vào orderDetails
		List<OrderDetail> orderDetails = orderDetailRepository.lisorderbydesc();
		//gán orderDetails vào model.addAttribute("orderDetails
